...
export default function ShowAdminInfo({user, isProjectLoading}) {
                        ...
                        <>
                            <Flex flexDirection='row' mb='30'>
                                <Flex flexDirection='column' w='417px'>
                                    <CustomInput label='NOMBRE DE USUARIO' height='47' defaultValue={user.username}/>
                                </Flex>
                            </Flex>
                            <Flex flexDirection='row' mb='30'>
                                <Flex flexDirection='column' w='417px'>
                                    <CustomInput label='CORREO ELECTRÓNICO' height='47' defaultValue={user.email}/>
                                </Flex>
                            </Flex>
                        </>}
                    </Flex>
